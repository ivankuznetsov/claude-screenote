...
By default `/screenote` captures the **entire scrolling page** (full-page screenshot), not just the first viewport. Pages taller than 5000 px are capped at 5000 px.
