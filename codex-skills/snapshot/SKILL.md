...
Use the canonical Viewport Dimensions table from the `screenote` skill (`codex-skills/screenote/SKILL.md` § Viewport Dimensions). Single source of truth — do not restate the pixel values here.
