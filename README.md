...
- Long or infinite-scroll pages are capped at the first **5000 px / 10 scrolls** so captures finish predictably.
...
3. **Screenshots every page at three viewports** — desktop, tablet, mobile (default), full-page with the 5000 px / 10-scroll cap
...
- ImageMagick (`convert` and `identify`) for fallback crop/stitch handling on very tall pages
